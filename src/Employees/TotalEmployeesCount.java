...
public class TotalEmployeesCount {
	...
	driver.get("http://designco.sia.co.in/");
	  ...
	  //Open page2
		...
		FileUtils.copyFile(scrFile6, new File("/home/aj/Documents/screenshots/EmployeeFullPage2.png"));
      //Open page3
		 employeeList.forwardbutton(driver).click();
		 Thread.sleep(6000);
	     File scrFile7 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);             
			FileUtils.copyFile(scrFile7, new File("/home/aj/Documents/screenshots/EmployeeFullPage3.png"));
	   //Open page4
		 employeeList.forwardbutton(driver).click();
		 Thread.sleep(6000);
		 File scrFile8 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);             
		 FileUtils.copyFile(scrFile8, new File("/home/aj/Documents/screenshots/EmployeeFullPage4.png"));
				
	   //Open page5
		 employeeList.forwardbutton(driver).click();
		 Thread.sleep(6000);
		 File scrFile9 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);             
		 FileUtils.copyFile(scrFile9, new File("/home/aj/Documents/screenshots/EmployeeFullPage5.png"));
	   //Open page6
		 employeeList.forwardbutton(driver).click();
		 Thread.sleep(6000);
		 File scrFile10 = ((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);             
		 FileUtils.copyFile(scrFile10, new File("/home/aj/Documents/screenshots/EmployeeFullPage6.png"));
