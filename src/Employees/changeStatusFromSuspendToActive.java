...
public class changeStatusFromSuspendToActive {
	@Test
	...
	WebDriver driver=new ChromeDriver();
      ...
      //Open User Profile
	   ...
	   //Change Status From Suspend to Active
		 boolean Suspend =findElement(((WebElement) By.xpath("(//span[@text='_ngcontent-pqw-53'])")).isEnabled();
	
		Thread.sleep(5000);
		WebElement Suspend1=driver.findElement(By.xpath("(//span[@text='_ngcontent-pqw-53'])"));
		
		 if(Suspend1.isEnabled())
		 {
			
			 System.out.println("User's status is suspend");
			 Thread.sleep(6000);
			 employeeList.view(driver).click();
		 ...
		 {
			 System.out.println("User's ststus is active");
