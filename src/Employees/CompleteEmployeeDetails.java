...
public class CompleteEmployeeDetails {
	@Test
	...
	WebDriver driver=new ChromeDriver();
	  ...
	  //Print all the details of a user
		WebElement email= driver.findElement(By.xpath("//*[text()= 'vipullohia@gmail.com']"));
		System.out.println("Details of the User");
		System.out.println("Email Id " + email.getText());
		
		WebElement contactNo= driver.findElement(By.xpath("//*[text()= '9319312345']"));
		System.out.println("Contact No " + contactNo.getText());
		
		WebElement DOB= driver.findElement(By.xpath("//*[text()= '---']"));
		System.out.println("DOB" + DOB.getText());
		
		WebElement bloodGroup= driver.findElement(By.xpath("//*[text()= '---']"));
		System.out.println("Blood Group " + bloodGroup.getText());
